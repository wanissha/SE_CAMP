            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="/titles<?php if(isset($title_id)) echo '/'. $title_id->tit_id; ?>"
                            method="POST"
                        >
                        ...
                        @csrf
                          <div class="card-body">
                            <div class="form-group">
                              ...
                              <input type="text" name="tit_name" value="<?php if(isset($title_id)) { echo $title_id->tit_name; }?>" class="form-control" id="exampleInputEmail1" placeholder="เช่น นาย/นางสาว/นาง ฯลฯ">
                            </div>
